...
func TestCreateUser(t *testing.T) {
	...
	samples := []struct {
		...
		{
			inputJSON:    `{"address":"Jl.sukma jaya", "email": "sukma@gmail.com", "password": "password"}`,
			statusCode:   201,
			address:      "Jl.sukma jaya",
			email:        "sukma@gmail.com",
			errorMessage: "",
		},
		{
			inputJSON:    `{"address":"Jl.Frangius", "email": "sukma@gmail.com", "password": "password"}`,
			statusCode:   500,
			errorMessage: "Email Already Taken",
		},
		{
			inputJSON:    `{"address":"Jl.sukma jaya", "email": "grand@gmail.com", "password": "password"}`,
			statusCode:   500,
			errorMessage: "Address Already Taken",
		},
		{
			inputJSON:    `{"address":"Jl.testing", "email": "testing02gmail.com", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Invalid Email",
		},
		{
			inputJSON:    `{"address": "", "email": "testing02@gmail.com", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Required Address",
		},
		{
			inputJSON:    `{"address": "Jl.testing", "email": "", "password": "password"}`,
			statusCode:   422,
			errorMessage: "Required Email",
		},
		{
			inputJSON:    `{"address": "Jl.testing", "email": "testing02@gmail.com", "password": ""}`,
			statusCode:   422,
...
func TestGetUserByID(t *testing.T) {
	...
	for _, v := range userSample {
		...
		if v.statusCode == 200 {
			assert.Equal(t, user.Address, responseMap["address"])
...
func TestUpdateUser(t *testing.T) {
	...
	samples := []struct {
	...
	}{
		{
			...
			updateJSON:    `{"address":"Jl.Sukma", "email": "sukma@gmail.com", "password": "password"}`,
			statusCode:    200,
			updateAddress: "Jl.Sukma",
			updateEmail:   "sukma@gmail.com",
		...
		},
		{
			...
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"address":"Jl.Melati", "email": "melati@gmail.com", "password": ""}`,
			statusCode:   422,
			tokenGiven:   tokenString,
			errorMessage: "Required Password",
		},
		{
			...
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"address":"Jl.pondokgede", "email": "pondokgede@gmail.com", "password": "password"}`,
			statusCode:   401,
			tokenGiven:   "",
		...
		{
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"address":"Jl.pondokgede", "email": "testinggmail.com", "password": "password"}`,
			statusCode:   422,
			tokenGiven:   tokenString,
			errorMessage: "Invalid Email",
		},
		{
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"address": "", "email": "grand@gmail.com", "password": "password"}`,
			statusCode:   422,
			tokenGiven:   tokenString,
			errorMessage: "Required Address",
		},
		{
			id:           strconv.Itoa(int(AuthID)),
			updateJSON:   `{"address":"Jl.Batu tinggi", "email": "", "password": "password"}`,
			statusCode:   422,
			tokenGiven:   tokenString,
			errorMessage: "Required Email",
		},
		...
		},
		{
			...
			updateJSON:   `{"address": "Jl.Apel No.99", "email": "testing@gmail.com", "password": "password"}`,
			tokenGiven:   tokenString,
			statusCode:   401,
			errorMessage: "Unauthorized",
		},
	...
	for _, v := range samples {
		...
		assert.Equal(t, rr.Code, v.statusCode)
		if v.statusCode == 200 {
			assert.Equal(t, responseMap["address"], v.updateAddress)
